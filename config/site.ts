export const siteConfig = {
  ...
  social: {
    ...
    facebook: 'https://facebook.com/irfatech',
    instagram: 'https://instagram.com/irfatech',
  },
}
...
export const industries = [
  { icon: 'lucide:building-2', label: 'Real Estate', desc: 'Property management, listings, and CRM' },
  { icon: 'lucide:shopping-bag', label: 'Retail Shops', desc: 'POS, inventory, and customer management' },
  { icon: 'lucide:truck', label: 'Distributors', desc: 'Supply chain, billing, and logistics' },
  { icon: 'lucide:stethoscope', label: 'Clinics', desc: 'Patient records, appointments, and billing' },
  { icon: 'lucide:utensils', label: 'Restaurants', desc: 'Orders, menu management, and analytics' },
  { icon: 'lucide:graduation-cap', label: 'Coaching Centers', desc: 'Enrollment, scheduling, and payments' },
  { icon: 'lucide:briefcase', label: 'SMB Enterprises', desc: 'End-to-end digital business infrastructure' },
]
