...
export const AchievementCard: typeof import("../components/AchievementCard.vue").default
export const AmbassadorCarAnimation: typeof import("../components/AmbassadorCarAnimation.vue").default
...
export const JourneyCard: typeof import("../components/JourneyCard.vue").default
...
export const SectionsAboutSaloo: typeof import("../components/sections/AboutSaloo.vue").default
export const SectionsAmbassadorCar: typeof import("../components/sections/AmbassadorCar.vue").default
export const SectionsChoudhuryTrophy: typeof import("../components/sections/ChoudhuryTrophy.vue").default
export const SectionsContessaClassicCar: typeof import("../components/sections/ContessaClassicCar.vue").default
export const SectionsGalleryPreview: typeof import("../components/sections/GalleryPreview.vue").default
export const SectionsGuinnessWorldRecords: typeof import("../components/sections/GuinnessWorldRecords.vue").default
export const SectionsHeroSection: typeof import("../components/sections/HeroSection.vue").default
export const SectionsTimelineTeaser: typeof import("../components/sections/TimelineTeaser.vue").default
...
export const LazyAchievementCard: LazyComponent<typeof import("../components/AchievementCard.vue").default>
export const LazyAmbassadorCarAnimation: LazyComponent<typeof import("../components/AmbassadorCarAnimation.vue").default>
...
export const LazyJourneyCard: LazyComponent<typeof import("../components/JourneyCard.vue").default>
...
export const LazySectionsAboutSaloo: LazyComponent<typeof import("../components/sections/AboutSaloo.vue").default>
export const LazySectionsAmbassadorCar: LazyComponent<typeof import("../components/sections/AmbassadorCar.vue").default>
export const LazySectionsChoudhuryTrophy: LazyComponent<typeof import("../components/sections/ChoudhuryTrophy.vue").default>
export const LazySectionsContessaClassicCar: LazyComponent<typeof import("../components/sections/ContessaClassicCar.vue").default>
export const LazySectionsGalleryPreview: LazyComponent<typeof import("../components/sections/GalleryPreview.vue").default>
export const LazySectionsGuinnessWorldRecords: LazyComponent<typeof import("../components/sections/GuinnessWorldRecords.vue").default>
export const LazySectionsHeroSection: LazyComponent<typeof import("../components/sections/HeroSection.vue").default>
export const LazySectionsTimelineTeaser: LazyComponent<typeof import("../components/sections/TimelineTeaser.vue").default>
