...
export const navItems: NavItem[] = [
  ...
  { label: 'Solutions', href: '/solutions', order: 2, labelKey: 'nav.items.solutions' },
...
export const footerLinkGroups: FooterLinkGroupConfig[] = [
  {
    ...
    links: [
      ...
      { label: 'Email', href: 'mailto:irfatech.in@gmail.com' },
      { label: 'Call (India)', href: 'tel:+918864812200' },
      { label: 'Call (Timor-Leste)', href: 'tel:+67075589557' },
      { label: 'GitHub', href: 'https://github.com/webbello/irfatech', external: true },
    ],
  },
];
