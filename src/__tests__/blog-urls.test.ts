...
// This file exercises the single-locale, i18n-off code path specifically —
// mocked explicitly rather than relying on the live config, so it keeps
// covering that guarantee regardless of how many locales this site ships.
// The enabled/multi-locale path is covered separately in
// `blog-urls-i18n.test.ts`.
