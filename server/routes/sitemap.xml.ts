export default defineEventHandler(async (event) => {
  ...
  const routes = [
    ...
    { url: '/services/erp-solutions', changefreq: 'monthly', priority: 0.8 },
    { url: '/services/crm-automation', changefreq: 'monthly', priority: 0.8 },
    { url: '/services/ai-workflows', changefreq: 'monthly', priority: 0.8 },
