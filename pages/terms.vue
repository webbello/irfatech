<template>
  <div class="pt-16">
    <section class="section-padding section-dark relative overflow-hidden">
      <div class="absolute inset-0 bg-hero-mesh pointer-events-none opacity-40"></div>
      <div class="container-max relative max-w-3xl mx-auto">
        <div class="badge mb-6">Legal</div>
        <h1 class="text-3xl md:text-4xl font-bold text-white mb-3">Terms of Service</h1>
        <p class="text-slate-500 text-sm">Last updated: May 2026</p>
      </div>
    </section>
